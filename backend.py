...
advance_prompt = """give detailed prompt for advance data analysis, which must include decribe, corr, univariate numerical and object column analysis
bivariate analysis, time series if any data column given multivariate analysis to perform different col like example sales, region, segment, using bar
plot with hue, give code with srict python and module code with the pip install for any unknown new module
if required"""

response = agent.invoke(
    {'messages': [{'role': 'user', 'content': advance_prompt}]}
)
